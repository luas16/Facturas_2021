...
class SaleListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('ctrl:sale_create')
        context['list_url'] = reverse_lazy('ctrl:sale_list')
...
class SaleCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('ctrl:sale_list')
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            context = {
                ...
                'comp': {'name': 'Importadora S.A.', 'Nit': '123456', 'Dirección': 'Cuidad, Guatemala'},
            ...
            pass
        return HttpResponseRedirect(reverse_lazy('ctrl:sale_list'))

class EstadoView(TemplateView):
    template_name = 'sale/estado.html'
